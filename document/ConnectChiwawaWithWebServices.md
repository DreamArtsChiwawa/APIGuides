...
1. 知話輪のアプリ、ユーザアカウント、Bot管理権限
    - 知話輪は下記のサイトから無料でお試しいただけます。自社環境で本格的にセットアップして使い始める前に手軽に試したい場合などは、下記をご利用ください。
        - [プロダクト無料トライアル](https://www.dreamarts.co.jp/product/trial/?ml)
        - お手数ですが、お申込み画面の「トライアルに関するご希望」欄に「API利用希望」とご記入ください。
1. zapierアカウント
1. Chromeブラウザ
